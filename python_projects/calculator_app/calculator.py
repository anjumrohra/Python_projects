...
class Application(Frame):
    ...
    def create_widgets(self):
        ...
        self.user_input = Entry(self, bg = "light blue", bd = 20, 
        ...
        # Equal button
        self.Equalbutton = Button(self, bg = "yellow", bd = 12, 
        ...
        # Clear Button
        self.Clearbutton = Button(self, bg = "yellow", bd = 12,
...
calculator.title("Calculator Application")
